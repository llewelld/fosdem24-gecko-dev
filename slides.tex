...
\item {\tt glibc}, {\tt busybox}, native or libhybris.
\item When I was at Jolla I worked on many different things, including: user interface, core apps, email client, Exchange support, Settings app, cloud sync.
...
A developer diary is where you write about developer things. It can be the record of what you worked on last, some decisions made by steak-holders [sic] in the product, and or a neat way to accomplish a task. It really comes down to what you want to put in it.
\end{shadequote}
...
\item But my motivation was different: first to help me code; second to involve the Sailfish community.
\end{enumerate}
}
...
\item I needed help with: coding ideas; testing; other components (e.g. gcc, Rust); motivation.
\end{enumerate}
}
...
\item Write about what your tomorrow-self will need to know
\end{enumerate}
